            ...
            <nav>
                ...
                <div>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item" href="../pages/cadastroTamanho.php">Tamanho</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="../pages/venda.php">Histórico</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="../pages/cadastroVenda.php">Gerar</a>
                        </li>
                    </ul>
                </div>
            </nav>
